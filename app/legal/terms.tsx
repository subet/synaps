...
const SECTIONS: Record<string, { title: string; body: string }[]> = {
  ...
  ja: [
    {
      title: '1. 規約への同意',
      body: `Synaps（以下「本アプリ」）をダウンロード、インストール、または使用することにより、お客様は本利用規約に同意したものとみなされます。同意されない場合は、本アプリのご使用をお控えください。\n\n本規約は、お客様とイングランドおよびウェールズで登記された会社であるMudimedia Ltd（以下「当社」）との間の法的拘束力のある契約です。`,
    },
    {
      title: '2. サービスの説明',
      body: `Synapsは、情報の記憶と定着を支援するために設計された間隔反復学習の単語カードアプリです。本アプリは主にオフラインで動作します。インターネット接続はアカウント作成、クラウド同期（PRO）、ライブラリのダウンロードにのみ必要です。`,
    },
    {
      title: '3. ユーザーアカウント',
      body: `Synapsはアカウントなしでも使用できます。アカウントを作成する場合、認証情報の機密保持はお客様の責任となります。正確な情報を提供し、不正アクセスに気づいた場合は直ちに当社にご連絡ください。\n\nアカウントを作成するには13歳以上である必要があります。`,
    },
    {
      title: '4. サブスクリプションと支払い',
      body: `Synapsには無料プランとPROサブスクリプションがあります。PROサブスクリプションはApple App StoreまたはGoogle Play Storeを通じて請求されます。価格は購入前に表示され、地域によって異なる場合があります。\n\nサブスクリプションは、現在の期間終了の24時間前までにキャンセルされない限り自動更新されます。サブスクリプションは端末のアカウント設定で管理・キャンセルできます。適用法で義務付けられている場合を除き、サブスクリプション期間の途中での返金は行われません。`,
    },
    {
      title: '5. ユーザーコンテンツ',
      body: `お客様が作成したカードコンテンツの所有権はお客様に帰属します。本アプリを使用することにより、お客様は当社に対し、サービス提供のみを目的としてコンテンツを保存・表示するための限定的かつ非独占的なライセンスを付与します。\n\n違法、有害、名誉毀損にあたる、または第三者の知的財産権を侵害するコンテンツを作成しないことに同意するものとします。`,
    },
    {
      title: '6. 知的財産権',
      body: `本アプリのデザイン、コード、グラフィック、および既製ライブラリデッキはすべてMudimedia Ltdまたはそのライセンサーの財産であり、知的財産法によって保護されています。当社の書面による事前の同意なしに、複製、改変、配布、または派生物の作成を行うことはできません。`,
    },
    {
      title: '7. 保証の免責',
      body: `本アプリは、明示または黙示を問わずいかなる保証もなく「現状のまま」および「提供可能な状態で」提供されます。本アプリが中断されないこと、エラーがないこと、ウイルスやその他の有害な要素がないことを保証するものではありません。`,
    },
    {
      title: '8. 責任の制限',
      body: `法律で認められる最大限の範囲において、Mudimedia Ltdは、本アプリの使用または使用不能から生じる間接的、付随的、特別、結果的、または懲罰的損害について、たとえその可能性について知らされていた場合であっても、一切責任を負いません。\n\nいかなる請求に対する当社の責任総額も、請求に先立つ12か月間にお客様が当社に支払った金額を超えないものとします。`,
    },
    {
      title: '9. 準拠法',
      body: `本規約はイングランドおよびウェールズの法律に準拠します。紛争はイングランドおよびウェールズの裁判所の専属管轄に服するものとします。`,
    },
    {
      title: '10. 規約の変更',
      body: `当社は本規約を随時更新することがあります。重要な変更は本アプリ内で通知されます。通知後も使用を継続した場合、更新された規約に同意したものとみなされます。`,
    },
    {
      title: '11. お問い合わせ',
      body: `本規約に関するご質問は、以下までお問い合わせください：\n\nMudimedia Ltd\nLondon, United Kingdom\nsynaps@mudimedia.co.uk`,
    },
  ],
};
