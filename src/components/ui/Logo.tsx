...
const LOGO_LIGHT = `<svg width="2400" height="600" viewBox="0 0 2400 600" xmlns="http://www.w3.org/2000/svg">
  <defs>
  ...
  <text x="720" y="365" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif" font-size="280" font-weight="400" fill="url(#text-grad)" letter-spacing="-6">synaps</text>
</svg>`;

const LOGO_DARK = `<svg width="2400" height="600" viewBox="0 0 2400 600" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="bg" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="#4361EE"/>
      <stop offset="50%" stop-color="#7C3AED"/>
  ...
  <text x="720" y="365" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif" font-size="280" font-weight="400" fill="#FFFFFF" letter-spacing="-6">synaps</text>
</svg>`;
...
export function Logo({ height = 32 }: LogoProps) {
  ...
  const xml = colorScheme === 'dark' ? LOGO_DARK : LOGO_LIGHT;
  const width = height * 4; // viewBox is 2400x600 → 4:1 ratio
