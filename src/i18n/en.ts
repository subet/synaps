export const en = {
  ...
  trial_badge: '%{n}-day free trial',
  trial_then_price: '%{n} days free, then %{price}%{period}',
  cta_start_trial: 'Start %{n}-Day Free Trial',
  footer_renewal_with_trial: "Your subscription renews automatically after the %{n}-day free trial ends. Cancel anytime at least 24 hours before the end of the current period.",
